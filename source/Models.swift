...
var sampleOrders = [
    ...
    CompletedOrder(id: UUID(), summary: "Multi-Grain toast", bread:.multigrain, purchaseDate: "5/28/19 1:13PM", quantity: 1, toppings: [.salt, .chives]),
    ...
    CompletedOrder(id: UUID(), summary: "Wheat with Tapenade", bread:.wheat, spread: .tapenade, purchaseDate: "5/25/19 5:40 PM",  quantity: 1, toppings: [.pickledOnion, .watermelonRadish, .chives]),
    ...
    CompletedOrder(id: UUID(), summary: "Multi-Grain Toast", bread:.multigrain, purchaseDate: "5/20/19 10:47 AM", quantity: 1, toppings: [.salt, .eggs]),
